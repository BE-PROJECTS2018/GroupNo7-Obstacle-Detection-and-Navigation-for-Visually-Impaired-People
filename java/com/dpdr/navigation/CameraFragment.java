        ...
        tts=new TextToSpeech(getActivity(), new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                if(status != TextToSpeech.ERROR) {
                    ...
                    Log.e("Say it","Setting Language in Train Activity");
                    tts.speak("Training mode", TextToSpeech.QUEUE_FLUSH, null);
                }
            }
        });
...
//                    Log.d(TAG, "cover height " + topCoverView.getHeight());
        ...
        final ImageView swapCameraBtn = (ImageView) view.findViewById(R.id.moveRight);
...
//                restartPreview();
        ...
        final View changeCameraFlashModeBtn = view.findViewById(R.id.moveLeft);
...
//                setupFlashMode();
        ...
        final ImageView takePhotoBtn = (ImageView) view.findViewById(R.id.queryButton);
...
//        Log.d(TAG, "onSaveInstanceState");
    ...
    public void onResume() {
        ...
        //NeuralNet.setContext(getContext());
    }
...
//        Log.d(TAG, "original bitmap width " + bitmap.getWidth() + " height " + bitmap.getHeight());
    ...
    public void onPause() {
        super.onPause();
        NeuralNet.getInstance().saveData(getActivity().getApplicationContext());
    }
