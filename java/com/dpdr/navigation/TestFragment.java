...
public class TestFragment extends Fragment implements SurfaceHolder.Callback, Camera.PictureCallback {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Log.e("Say it","Saying navigation mode");
        tts=new TextToSpeech(getActivity(), new TextToSpeech.OnInitListener() {
            @Override
            public void onInit(int status) {
                if(status != TextToSpeech.ERROR) {
                    tts.setLanguage(Locale.US);
                    Log.e("Say it","Setting Language in Test Activity");
                    tts.speak("navigation mode", TextToSpeech.QUEUE_FLUSH, null);
                }
            }
        });
...
//        Log.d(TAG, "onSaveInstanceState");
    ...
    private void takePicture() {
        ...
        if (mIsSafeToTakePhoto) {
            ...
            //Toast.makeText(getContext(),"Reached here!!",Toast.LENGTH_LONG).show();
        ...
        protected void onPostExecute(Integer integer) {
            ...
            switch (integer.intValue()){
                ...
                case 2:
                    ...
                    break;
                case -1:
                    toSpeak = "this area is untrained, move back";
            }
            Log.e("Say it","Saying the direction");
